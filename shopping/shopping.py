...
def load_data(filename):
    ...
    with open(filename, 'r') as f:
        ...
        for row in data:
            ...
            labels.append(label[row['Revenue']])
...
def evaluate(labels, predictions):
    ...
    allcorrect = labels.count(1)
    allincorrect = labels.count(0)
    sensitivity = truepositive/allcorrect
    specificity = truenegative/allincorrect
